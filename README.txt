1.	
Install SQLite3. Use command: "sudo apt-get install sqlite3"

2.
Run SQLite3 with setup command using: "sqlite3 mydatabase.db < setup.txt"
...
5.
Run command: "python3 csv_to_xml.py".

4.	
In a new terminal, run command: "python3 xml_to_db.py mydatabase.db house.xml 60".
